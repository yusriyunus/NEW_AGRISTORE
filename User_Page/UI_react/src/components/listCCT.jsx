...
class CCTlist extends Component {
  ...
  onDetailClick = index => {
    ...
    this.setState({
      displayDetail: "flex",
      productOnClick: [this.state.productList[index], 0, index]
    });
    this.props.changeUrl(
      `${this.state.productList[index].category}&idProduct=${
        this.state.productList[index]._id
      }`
    );
    alert("clicked");
  };
  ...
  render() {
    console.log(this.state.productList, "productList");
    return (
